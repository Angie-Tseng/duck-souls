...
QT_MOC_LITERAL(1, 3, 8), // "add_mana"
QT_MOC_LITERAL(2, 12, 0), // ""
QT_MOC_LITERAL(3, 13, 6), // "aquire"
QT_MOC_LITERAL(4, 20, 8), // "set_pool"
QT_MOC_LITERAL(5, 29, 5) // "level"

    },
    "Ai\0add_mana\0\0aquire\0set_pool\0level"
};
...
void Ai::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->add_mana(); break;
        case 1: _t->aquire(); break;
        case 2: _t->set_pool((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
void *Ai::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QGraphicsPixmapItem"))
        return static_cast< QGraphicsPixmapItem*>(const_cast< Ai*>(this));
